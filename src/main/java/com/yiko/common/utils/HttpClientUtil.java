...
public class HttpClientUtil {
    ...
    public static String doGet(String url) {
        try {
            ...
            if (response.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
                ...
                if (isGzip) {
                    //需要进行gzip解压处理
                    strResult = EntityUtils.toString(new GzipDecompressingEntity(response.getEntity()));
                } else {
    ...
    public static String sendJSON(String url, JSONObject jsonParam) throws Exception {
        String result = "";
