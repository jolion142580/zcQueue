...
import com.yiko.common.domain.TaskDO;
...
public class JobController extends BaseController{
	...
	public PageUtils list(@RequestParam Map<String, Object> params) {
		...
		List<TaskDO> taskScheduleJobList = taskScheduleJobService.list(query);
		PageInfo<TaskDO> pageInfo =new PageInfo<>(taskScheduleJobList);
		PageUtils pageUtil = new PageUtils(taskScheduleJobList,new Long(pageInfo.getTotal()).intValue());
