...
import com.yiko.common.redis.shiro.RedisCacheManager;
import com.yiko.common.redis.shiro.RedisManager;
import com.yiko.common.redis.shiro.RedisSessionDAO;
import com.yiko.system.shiro.UserRealm;
...
//        filterChainDefinitionMap.put("/ss/chart/**", "anon");
        ...
        filterChainDefinitionMap.put("/ss/onlineApply/pushResult", "anon");
...
//        RetryLimitCredentialsMatcher matcher = new RetryLimitCredentialsMatcher(ehCacheManager(), "caChe");
