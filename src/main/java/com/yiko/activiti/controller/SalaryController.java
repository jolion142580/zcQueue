package com.yiko.activiti.controller;

import com.yiko.activiti.domain.SalaryDO;
import com.yiko.activiti.service.SalaryService;
import com.yiko.activiti.utils.ActivitiUtils;
...
public class SalaryController extends BaseController{
    ...
    public PageUtils list(@RequestParam Map<String, Object> params) {
       /* Query query = new Query(params);
        ...
        List<SalaryDO> salaryList = salaryService.list(query);
        PageInfo<SalaryDO> pageInfo =new PageInfo<>(salaryList);
        return new  PageUtils(salaryList,new Long(pageInfo.getTotal()).intValue());
    }
