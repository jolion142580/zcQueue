package com.yiko.oa.controller;
...
import com.yiko.oa.domain.NotifyDO;
import com.yiko.oa.domain.NotifyRecordDO;
import com.yiko.oa.service.NotifyRecordService;
import com.yiko.oa.service.NotifyService;
...
//	@RequiresPermissions("oa:notify:notify")
	public PageUtils list(@RequestParam Map<String, Object> params) {
		...
		List<NotifyDO> notifyList = notifyService.list(query);
		PageInfo<NotifyDO> pageInfo =new PageInfo<>(notifyList);
		PageUtils pageUtil = new PageUtils(notifyList,new Long(pageInfo.getTotal()).intValue());
